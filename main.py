...
def Binarize_image():
    ...
    parser.add_argument('--w', type=int, default=250, help='window size')
    parser.add_argument('--th', type=int, default=80, help='parametr threshold for method Niblack_multiscale')
    parser.add_argument('--sf', type=int, default=2, help='parametr scale factor for method Niblack_multiscale')
    ...
    try:
        ...
        for img_path in images:
            ...
            _, out_path, method, label_path, metric_type, k, a, window_size, threshold, scale_factor = args.__dict__.values()
            ...
            if label_path != 'None':
                ...
                mask = None
            bin_image = binarize(image, method, window_size, scale_factor, k, a, threshold)
